...
// values below can be found on Account tab in m2m.io portal (http://app.m2m.io)
// note:  password below is MD5 hash of password (32 character string)
// device type should be left as "things"
// choose any string for device ID
//    - any string that will uniquely identifies each of your devices
//    - some have chosen to use MAC address as a unique string
//    - serial number would also be a good choice
// broker IP and port should not be changed

#define  M2MIO_USERNAME   	"<insert m2m.io username here>"	// username on m2m.io portal
#define  M2MIO_PASSWORD   	"<insert m2m.io password here>"  // MD5 hash of password
#define  M2MIO_DOMAIN     	"<insert m2m.io domain here>"		// your domain string from m2m.io portal
